def all_thing_is_obj(object: any) -> int:
    """
    Diese Funktion nimmt ein beliebiges Objekt und druckt seinen Typ in einer speziellen Formatierung.
    Sie gibt immer 42 zurück, es sei denn, der Typ ist nicht gefunden.
    """
